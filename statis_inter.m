...
% Quelques affichages
%-------------------------------------------------------------------------------
% Qualités de représentation sur le plan factoriel

% 
% disp('Qualités de représentation des objets sur le plan');
% for i=1:n
%     qlt_rep_k1 = Co(i,1)/sum(Co(i,:));
%     qlt_rep_k2 = Co(i,2)/sum(Co(i,:));
%     qlt_rep_plan(i) = qlt_rep_k1 + qlt_rep_k2;
% end;
% disp(qlt_rep_plan);
